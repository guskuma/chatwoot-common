...
export const DATE_TIME_FUNCTIONS: SelectableTool[] = [
  {
...
export const CALENDAR_FUNCTIONS: SelectableTool[] = [
  {
...
export const CHATWOOT_FUNCTIONS: SelectableTool[] = [
  {
...
export function getPredefinedFunction(name: string): SelectableTool | undefined {
  return PREDEFINED_FUNCTIONS.find(func => func.name === name);
}

// Função helper para buscar funções por categoria
export function getPredefinedFunctionsByCategory(category: string): SelectableTool[] {
  return PREDEFINED_FUNCTIONS.filter(func => func.category === category);
}

// Função helper para obter todas as categorias disponíveis
export function getPredefinedFunctionCategories(): string[] {
  const categories = PREDEFINED_FUNCTIONS
